...
type UserServiceClient interface {
	...
	List(ctx context.Context, in *Filters, opts ...grpc.CallOption) (*Users, error)
}
...
func (c *userServiceClient) Profile(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (c *userServiceClient) List(ctx context.Context, in *Filters, opts ...grpc.CallOption) (*Users, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Users)
...
type UserServiceServer interface {
	...
	List(context.Context, *Filters) (*Users, error)
...
func (UnimplementedUserServiceServer) Profile(context.Context, *User) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Profile not implemented")
}
func (UnimplementedUserServiceServer) List(context.Context, *Filters) (*Users, error) {
...
func _UserService_Profile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Profile(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).List(ctx, req.(*Filters))
	}
	return interceptor(ctx, in, info, handler)
}
