...
const (
	GeoProvider_AddressSearch_FullMethodName = "/dadata_grpc.GeoProvider/AddressSearch"
	GeoProvider_GeoCode_FullMethodName       = "/dadata_grpc.GeoProvider/GeoCode"
)
...
type GeoProviderClient interface {
	AddressSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Addresses, error)
	GeoCode(ctx context.Context, in *GeocodeRequest, opts ...grpc.CallOption) (*Addresses, error)
}
...
func (c *geoProviderClient) AddressSearch(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Addresses, error) {
...
func (c *geoProviderClient) GeoCode(ctx context.Context, in *GeocodeRequest, opts ...grpc.CallOption) (*Addresses, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Addresses)
...
type GeoProviderServer interface {
	AddressSearch(context.Context, *SearchRequest) (*Addresses, error)
	GeoCode(context.Context, *GeocodeRequest) (*Addresses, error)
...
func (UnimplementedGeoProviderServer) AddressSearch(context.Context, *SearchRequest) (*Addresses, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddressSearch not implemented")
}
func (UnimplementedGeoProviderServer) GeoCode(context.Context, *GeocodeRequest) (*Addresses, error) {
...
func _GeoProvider_AddressSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoProviderServer).AddressSearch(ctx, req.(*SearchRequest))
	}
...
var GeoProvider_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dadata_grpc.GeoProvider",
	...
	Metadata: "geo_proto/dadata.proto",
}
